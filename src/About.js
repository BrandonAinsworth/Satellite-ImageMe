...
return (
  ...
  <section className="about">
    <div>Satellite ImageMe</div>
    <p>Satellite ImageMe is an educational website to bolster interest in satellites and space technology.</p>
  </section>
  <section className="about">
    <div>ImageMe</div>
    <p>What is an API?</p>
    <p>An API (Application Programming Interface) is a common way for applications to communicate information
    ...
    <p>ImageMe uses two API's to get an image of your location, NASA's EarthAPI and the Geolocation API developed by the World Wide Web Consortium (W3C)</p>
    <p>When you click the 'GO!' button, we first use the Geolocation API to find your latitude and longitude. This is accomplished largely by the 
    ...
    <p>Once your coordinates have been determined, we then make a request to NASA to give us some data back through their Earth API. 
    ...
    <p>So, how do satellites work?</p>
    <p>Some satellites don't do anything at all! A satellite is categorized as a space-object that orbits a larger body. By this definition, 
    ...
    <p>Satellites generally serve 1-3 purposes, communication, navigation, and imaging. Here we will focus how imaging satellites operate.</p>
    <p>The satellite used by ImageMe through NASA and the USGS is called Landsat 8. It was launched February 11, 2013 and is part of a larger mission called Landsat, 
    ...
    <p>Important to note is that satellite imaging is used for much more than simply taking a picture like you may here on Earth. Satellites often come with a variety of
    ...
    <p>With all this in mind, you may be wondering how Landsat 8 delivered you a photo from your location. Well if you've been following closely, you might realize that Landsat 8 actually didn't take any photos at all!
